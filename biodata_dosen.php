...
<head>
    ...
    <title>Kuesioner Dosen Penelitian Kesiapan E-Learning </title>
...
<body>
		...
		//mengambil data di setting, kalau proses validitas sudah berjalan masukkan ke variabel.ntar action di arahkan ke variabel
			...
			$link="kuesioner_dosen_ujicoba.php";
...
<hr>
                  ...
                  <div>
                    ...
                    <input type="text" name="nama_dosen" id="name" class="placeholder" placeholder="Masukkan Nama Lengkap" required>
                    
					<label for="nip" id="name-label">NIP/NIK:</label>
					<input type="text" name="nip" id="name" class="placeholder" placeholder="Masukkan NIP/NIK" required>
