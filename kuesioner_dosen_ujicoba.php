...
-->
       ...
       <div id="formContainer">
                <form id="survey-form" method="post" action="simpan_ujicoba.php">
...
<br/>
				  ...
				  //$satu='';
					...
					$kodepertanyaansaatini="qd".''.$loop;
					
					
					$querypertanyaanmhs=mysqli_query($kon,"select * from butir_pertanyaan_dosen where kode_pertanyaan='$kodepertanyaansaatini'");
...
?>
				 ...
				 ?></p>
				  ...
				  <div>
                    <center>       
                    <textarea class="placeholder" name="qd_terbuka" rows="5" cols="33" placeholder="Tuliskan saran anda disini" style="height:100px;resize:vertical;"></textarea>
                  </center>
				  </div>
                  <hr>
