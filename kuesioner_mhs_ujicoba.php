...
<head>
    ...
    <title>Kuesioner Mahasiswa</title>
...
-->
       ...
       <div id="formContainer">
                <form id="survey-form" method="post" action="simpan_mhs_ujicoba.php">
...
<br/>
				  ...
				  //$satu='';
					...
					$kodepertanyaansaatini="qm".''.$loop;
					
					
					$querypertanyaanmhs=mysqli_query($kon,"select * from butir_pertanyaan_mhs where kode_pertanyaan='$kodepertanyaansaatini'");
...
?>
				 ...
				 //Ini yang membedakan antara pertanyaan ujocoba dan utama. jika utama, ada if, jika ujicoba tidak ada
				 //if($kevalidan=='Valid'){
				 ...
				 ?></p>
				  ...
				  <div>
                    <center>       
                    <textarea class="placeholder" name="qm_terbuka" rows="5" cols="33" placeholder="Tuliskan saran anda disini" style="height:100px;resize:vertical;"></textarea>
                  </center>
				  </div>
                  <hr>
