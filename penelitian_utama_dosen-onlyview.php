...
<html lang="en">
  <head>
  	<title>Hasil Analisis Responden Dosen</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4" align="center">Hasil Analisis Responden Dosen</h2>
...
<?php
		...
		Ini adalah batas koding. Koding dibawah adalah koding untuk mendapatkan nilai dosen seior dan dosen junior
		Koding untuk mendapatkan nilai kesiapan dosen muda.
		...
		<form action="penelitian_utama_admin-onlyview.php" method="post">
