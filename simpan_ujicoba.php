...
//ambil kode responden dari jumlah data saat ini +1.
				$query_respondenku = mysqli_query($kon,"select Count(*) as totalper_dosen from dosen_ujicoba");
...
//Query input menginput data kedalam tabel barang
  $sql="insert into dosen_ujicoba (kode_responden,waktu,nama,nip,jurusan,prodi,usia,qd_terbuka) values
...
//untuk menyimpan ke db, pake looping di postnya. Ini ditaruh dibawah karena pake query update, jadi yang lain diinput dulu. ini belakangan
				...
				while ($i<=$jml_pert_mhs){
					...
					//if($kevalidan=='Valid'){
						...
						$set_update_qm = mysqli_query($kon,"update dosen_ujicoba set $kodepertanyaansaatini='$nilaiyangdiinput' where kode_responden='$koderesponden' ");
