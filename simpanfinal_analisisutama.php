...
$buat_baris_total = mysqli_query($kon,"INSERT INTO `setting`(`nama`, `ketentuan`) VALUES ('prosesanalisisutama','sudah')");
...
echo "<br/>baris total sudah diinsert";
	...
	$set_update_jml = mysqli_query($kon,"update setting set ketentuan='sudah' where nama='prosesanalisisutama' ");
