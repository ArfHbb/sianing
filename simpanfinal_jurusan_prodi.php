...
$buat_baris_total = mysqli_query($kon,"INSERT INTO `setting`(`nama`, `ketentuan`) VALUES ('statusfinaljurusanprodi','sudah')");
...
echo "<br/>baris total sudah diinsert";
	...
	$set_update_jml = mysqli_query($kon,"update setting set ketentuan='sudah' where nama='statusfinaljurusanprodi' ");
